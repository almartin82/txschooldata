...
Texas border counties face unique enrollment pressures. **Brownsville ISD** lost **13.9%** of its students, while **Laredo ISD** dropped **13.1%**—among the steepest declines in the state.
...
While Dallas ISD and Fort Worth ISD lose students, surrounding suburban districts are growing. **Prosper ISD** grew by **69.1%** (+11,605 students) since 2020, while **Frisco ISD** added 3,980 students (+6.4%).
...
These twelve findings illustrate the rapid transformation of Texas public education:
