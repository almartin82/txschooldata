...
This is an R package for fetching and processing Texas school data from the Texas Education Agency (TEA).

### Key Data Characteristics

- **Data Source**: Texas Education Agency (TEA) at https://tea.texas.gov/reports-and-data
- **ID System**:
  - District IDs: 6 digits (e.g., 101912 for Austin ISD)
  - Campus IDs: 9 digits (district ID + 3-digit campus number)
- **Primary Data System**: PEIMS (Public Education Information Management System)
