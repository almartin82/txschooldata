...
# State Schooldata Package Instructions
...
## Git Commits and PRs (NY, TX STRICT)

**New York and Texas packages follow STRICTER Git policies:**
...
- **NEVER** add AI-generated attribution trailers or acknowledgments
- Keep commit messages focused on what changed, not how it was written

**All other states:** Standard policy applies - NO AI MENTIONS but less explicit enforcement.
...
|------|------------|----------------|-------|
| 2021 | Yes | Yes | Texas Education Agency (TEA) |
| 2022 | Yes | Yes | Texas Education Agency (TEA) |
| 2023 | Yes | Yes | Texas Education Agency (TEA) |
| 2024 | Yes | Yes | Texas Education Agency (TEA) |
| 2025 | Yes | Yes | Texas Education Agency (TEA) |

**Data Source:** Texas Education Agency (TEA)
- URL: https://tea.texas.gov/
- API: TAPR (Texas Academic Performance Reports)
