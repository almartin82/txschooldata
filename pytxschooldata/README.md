...
Python wrapper for Texas school enrollment data.

This is a thin rpy2 wrapper around the [txschooldata](https://github.com/almartin82/txschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `txschooldata` R package installed
...
# Fetch one year
df = tx.fetch_enr(2025)

# Fetch multiple years
df_multi = tx.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
