...
get_available_years <- function() {
  list(
    min_year = 1997L,
    max_year = 2026L,
    description = "Texas enrollment data from TEA is available for school years 1996-97 through 2025-26 (end years 1997-2026). Data sources: AEIS CGI (1997-2002), AEIS SAS (2003-2012), TAPR (2013-2026)"
  )
}
