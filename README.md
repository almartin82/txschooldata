...
An R package for fetching and processing Texas school enrollment,
graduation, and assessment data from the Texas Education Agency (TEA).
Texas public schools enroll **5.5 million students** across 1,200+
districts – the second-largest school system in the United States. One
function call pulls it all into R.
...
<figure>
<img
src="https://almartin82.github.io/txschooldata/articles/district-hooks_files/figure-html/covid-plot-1.png"
alt="COVID enrollment drop" />
<figcaption aria-hidden="true">COVID enrollment drop</figcaption>
</figure>
...
<figure>
<img
src="https://almartin82.github.io/txschooldata/articles/district-hooks_files/figure-html/frisco-trend-1.png"
alt="Frisco Asian growth" />
<figcaption aria-hidden="true">Frisco Asian growth</figcaption>
</figure>
...
From 49,480 to **76,819 students** (+55.3%). Charter networks are
reshaping Texas education.
...
<figure>
<img
src="https://almartin82.github.io/txschooldata/articles/district-hooks_files/figure-html/diversity-chart-1.png"
alt="Fort Bend demographics" />
<figcaption aria-hidden="true">Fort Bend demographics</figcaption>
</figure>
...
<figure>
<img
src="https://almartin82.github.io/txschooldata/articles/district-hooks_files/figure-html/houston-vs-dallas-plot-1.png"
alt="Houston vs Dallas" />
<figcaption aria-hidden="true">Houston vs Dallas</figcaption>
</figure>
...
Hallsville ISD nearly doubled (+85.7%), Prosper ISD grew 69.1%. While
urban cores lose students, suburban boomtowns absorb the growth.
...
<figure>
<img
src="https://almartin82.github.io/txschooldata/articles/district-hooks_files/figure-html/pk-recovery-plot-1.png"
alt="Pre-K recovery" />
<figcaption aria-hidden="true">Pre-K recovery</figcaption>
</figure>

Pre-K cratered 21% during COVID. By 2024 it has clawed back to 247,979 –
still **434 students short** of 2020 levels.
...
<figure>
<img
src="https://almartin82.github.io/txschooldata/articles/district-hooks_files/figure-html/multiracial-plot-1.png"
alt="Multiracial growth" />
<figcaption aria-hidden="true">Multiracial growth</figcaption>
</figure>

From 138,434 to 173,425 – a **25% increase** in raw numbers. The
fastest-growing demographic group in Texas.
...
- **IDs:** District IDs are 6 digits (e.g., `101912` for Houston ISD).
...
- **Suppression:** TEA applies data masking to protect student privacy
  for small subgroups.
